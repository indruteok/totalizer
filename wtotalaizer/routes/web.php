...
Route::get('/totalizer', 'TotalizerController@index');
...
$this->get('loginsimple', 'Auth\LoginsimpleController@showLoginForm')->name('auth.loginsimple');
$this->post('loginsimple', 'Auth\LoginsimpleController@login')->name('auth.loginsimple');
